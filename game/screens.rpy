...
screen main_menu():
    ...
    # Logo (centralizado, mantém proporção)
    add "gui/logo_sem_fundo.png" xalign 0.2 yalign 0.3
...
##
## A tela de preferências permite que o jogador configure o jogo para se
## adequar melhor.
##
